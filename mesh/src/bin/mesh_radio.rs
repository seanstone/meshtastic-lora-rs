...
///
/// Drives the simulated AWGN or UHD radio in a background tokio task and
/// renders the shared [`ViewModel`] via [`mesh::view::MeshSimApp`]. Compiles
/// to native (tokio) and WASM (gloo-timers).
